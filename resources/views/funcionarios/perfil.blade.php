        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
            ...
            <div
                ...
                <div
                    ...
                    <div
                        class="absolute bottom-0 right-0 bg-cyan-500 text-white p-2 rounded-full shadow-md flex items-center justify-center pointer-events-none">
            ...
            <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 md:col-span-2 space-y-6">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        <label for="nome" class="block text-sm font-semibold text-slate-700 mb-1.5">Nome
                            completo</label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="telefone" value="{{ $funcionario->contato ?? 'Não informado' }}"
                                disabled
                                class="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-slate-600 text-sm outline-none cursor-not-allowed">
                        </div>
                    </div>
                    ...
                    <div>
                        <label for="email" class="block text-sm font-semibold text-slate-700 mb-1.5">E-mail de
                            contato</label>
                    ...
                    <div>
                        <label for="perfil" class="block text-sm font-semibold text-slate-700 mb-1.5">Cargo /
                            Função</label>
                        <input type="text" id="perfil" value="{{ $funcionario->perfil ?? 'Enfermeiro' }}"
                            disabled
                            class="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-slate-600 text-sm outline-none cursor-not-allowed">
                    </div>
