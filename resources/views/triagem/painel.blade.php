            ...
            <div class="md:col-span-5 space-y-6">
                <div class="grid grid-cols-2 gap-4">
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                        <span class="text-xs font-bold text-cyan-600 tracking-wider uppercase block mb-1">Aguardando Triagem</span>
                        <span class="text-4xl font-extrabold text-slate-800">3</span>
                    </div>
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                        <span class="text-xs font-bold text-cyan-600 tracking-wider uppercase block mb-1">Triados Hoje</span>
